            ...
            div {
                ...
                div { class: "flex flex-col gap-1.5",
                    ...
                    crate::components::Select {
                        ...
                        trigger_class: "border-border bg-muted/50 w-full",

                        value: "{leave_type}",

                        onchange: move |val: String| leave_type.set(val),

                        options: vec![

                            ("vacation".to_string(), t("reporting-leave-types-vacation", &props.locale)),

                            ("sick_leave".to_string(), t("reporting-leave-types-sick-leave", &props.locale)),

                            ("care_of_child".to_string(), t("reporting-leave-types-care-of-child", &props.locale)),

                            ("other".to_string(), t("reporting-leave-types-other", &props.locale)),
                ...
                div { class: "grid grid-cols-2 gap-4",
                    ...
                    div { class: "flex flex-col gap-1.5",
                        ...
                        crate::components::Input {
                            ...
                            oninput: move |e: FormEvent| leave_start.set(e.value()),
                    ...
                    div { class: "flex flex-col gap-1.5",
                        ...
                        crate::components::Input {
                            ...
                            oninput: move |e: FormEvent| leave_end.set(e.value()),
