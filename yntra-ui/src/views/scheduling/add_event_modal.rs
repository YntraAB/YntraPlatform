...
pub fn AddEventModal(props: AddEventModalProps) -> Element {
    ...
    // Collapsible states
    let mut show_overlap = use_signal(|| false);
    let mut show_breaks = use_signal(|| false);
    ...
    rsx! {
        components::Dialog {
            ...
            div { 
                ...
                // Date & Time Grid
                if template == yntra_core::WorkspaceTemplateType::Care {
