                ...
                div { class: "flex flex-col gap-4",
                    ...
                    div { class: "flex flex-col gap-1.5",
                        ...
                        crate::components::Select {
                            trigger_class: "text-sm h-9 px-3 bg-background border border-border rounded-lg text-foreground focus:outline-none focus:ring-1 focus:ring-primary/30",
                            value: "{selected_report_team_id}",
                            onchange: move |val: String| {
                                selected_report_team_id.set(val);
                            },
                            options: assistant_teams_list.iter().map(|t| (t.id.clone(), t.name.clone())).collect(),
                        }
                    }
                    // Date
                    div { class: "flex flex-col gap-1.5",
                        ...
                        crate::components::Input {
                            ...
                            r#type: "date",
                            value: "{time_date}",
                            oninput: move |e: FormEvent| time_date.set(e.value()),
                        }
                    }
                    // Start & End time
                    div { class: "flex gap-4",
                        div { class: "flex-1 flex flex-col gap-1.5",
                            ...
                            crate::components::Input {
                                ...
                                r#type: "time",
                                value: "{time_start}",
                                oninput: move |e: FormEvent| time_start.set(e.value()),
                            }
                        }
                        div { class: "flex-1 flex flex-col gap-1.5",
                            ...
                            crate::components::Input {
                                ...
                                r#type: "time",
                                value: "{time_end}",
                                oninput: move |e: FormEvent| time_end.set(e.value()),
                            }
                        }
                    }
                    // Total hours
                    div { class: "flex flex-col gap-1.5",
                        ...
                        crate::components::Input {
                            ...
                            step: "0.5",
                            value: "{time_hours}",
                            oninput: move |e: FormEvent| time_hours.set(e.value()),
                        }
                    }
                    // Comment/Note
                    div { class: "flex flex-col gap-1.5",
                        ...
                        crate::components::Input {
                            ...
                            value: "{time_note}",
                            oninput: move |e: FormEvent| time_note.set(e.value()),
                        }
                    }
                }
