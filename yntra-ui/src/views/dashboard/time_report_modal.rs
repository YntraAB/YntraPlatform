                ...
                div { class: "flex flex-col gap-5 text-sm",
                    div { class: "flex flex-col gap-1.5",
                        ...
                        crate::components::Select {
                            ...
                            onchange: move |val: String| selected_team_id.set(val),
                            options: {
                                ...
                                for c in clients.iter() {
                                    ...
                                    opts.push((format!("client-{}", c.id), format!("{} {} ({})", c.first_name, c.last_name, patient_lbl)));
                                }
                                opts
                            },
                        }
                    ...
                    style: "grid-template-columns:1fr 1fr;",
                        div { class: "flex flex-col gap-1.5",
                            ...
                            crate::components::Input {
                                ...
                                r#type: "text",
                                value: "{report_start}",
                                oninput: move |e: FormEvent| report_start.set(e.value()),
                            }
                        }
                        div { class: "flex flex-col gap-1.5",
                            label { class: "text-xs font-bold text-muted-foreground/60 uppercase",
                            ...
                            crate::components::Input {
                                ...
                                r#type: "text",
                                value: "{report_end}",
                                oninput: move |e: FormEvent| report_end.set(e.value()),
                            }
                        }
                    }
                    div { class: "flex flex-col gap-1.5",
                        ...
                        crate::components::Input {
                            ...
                            r#type: "text",
                            value: "{report_break}",
                            oninput: move |e: FormEvent| report_break.set(e.value()),
                        }
                    }
                    div { class: "flex flex-col gap-1.5",
                        label { class: "text-xs font-bold text-muted-foreground/60 uppercase",
                        ...
                        crate::components::Input {
                            ...
                            oninput: move |e: FormEvent| report_note.set(e.value()),
                        }
                    }
