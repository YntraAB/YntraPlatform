                    ...
                    components::CardContent { class: "space-y-6",
                        div { class: "space-y-2",
                            ...
                            crate::components::Select {
                                trigger_class: "h-10 border-border/50 bg-background/50",
                                ...
                                options: vec![
                                    ("day".to_string(), t("scheduler-views-day", &props.locale)),
                                    ("week".to_string(), t("scheduler-views-week", &props.locale)),
                                    ("month".to_string(), t("scheduler-views-month", &props.locale)),
                                    ("agenda".to_string(), t("scheduler-views-agenda", &props.locale)),
                                ],
                            }
                        }
