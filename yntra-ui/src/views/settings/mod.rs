                ...
                match display_tab.as_str() {
                    ...
                    "blocks" => rsx! {
                        BlockSettings {
                            ...
                            journals_enabled: props.journals_enabled,
                            medications_enabled: props.medications_enabled,
                            directory_enabled: props.directory_enabled,
                            reporting_enabled: props.reporting_enabled,
                            academics_enabled: props.academics_enabled,
                            attendance_enabled: props.attendance_enabled,
                            finance_enabled: props.finance_enabled,
                            library_enabled: props.library_enabled,
