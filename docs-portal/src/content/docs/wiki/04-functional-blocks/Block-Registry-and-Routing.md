---
title: "Block Registry & View Routing Guide"
head:
  - tag: script
    attrs:
      src: /target-blank.js
...
:::tip
To add a new operational block, append a new [`BlockDefinition`](https://github.com/YntraAB/YntraPlatform/blob/main/yntra-ui/src/blocks.rs#L2-L82) entry to [`BLOCK_REGISTRY`](https://github.com/YntraAB/YntraPlatform/blob/main/yntra-ui/src/blocks.rs#L29-L109) in `yntra-ui/src/blocks.rs#L29`.
:::
