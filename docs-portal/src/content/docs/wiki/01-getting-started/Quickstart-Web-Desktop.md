---
title: "Quickstart Web & Desktop (Dioxus 0.7+)"
head:
  - tag: script
    attrs:
      src: /target-blank.js
...
This guide walks through setting up, running, and building Yntra's Dioxus frontend ([`yntra-ui`](https://github.com/YntraAB/YntraPlatform/blob/main/yntra-ui)) for Web (WASM) and Desktop (Native Wry/GPUI).
